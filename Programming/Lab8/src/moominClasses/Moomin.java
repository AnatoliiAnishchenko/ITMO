...
public class Moomin extends Creature implements PickUpping, Wearing, Mining, Constants, Comparable<Moomin> {
    ...
    public Moomin(ZonedDateTime time, String name, Field field, TypeOfMoomin type, Gender gender, Position position, Condition condition, double X, double Y, int ownerId) {
    ...
    public Moomin(JSONObject objJSON) {
        ...
        try {
            ...
            X = Double.parseDouble((String) curMoominData.get("x"));
            Y = Double.parseDouble((String) curMoominData.get("y"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public JSONObject toJSON() {
        ...
        curMoominJSONData.put("field", getField().toString());
        ...
        curMoominJSONData.put("x", String.valueOf(getX()));
        curMoominJSONData.put("y", String.valueOf(getY()));
